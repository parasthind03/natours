...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicGFyYXN0aGluZCIsImEiOiJja3RpYWFkOHYwOTgxMndxcmJnbTYxOWF2In0.W87orfcHVjeVBhpe1ZM45w';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extends map bound to the current location
...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "C:\\Y IIIT SONEPAT\\node-bootcamp\\4-natours",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
//tyoe is either 'success' or 'error'
